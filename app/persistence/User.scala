...
case class UserRepository() extends ExtensionMethodConversions {
  ...
  val db    = JdbcBackend.Database.forURL("jdbc:mysql://localhost:3306/kidsna_db?characterEncoding=UTF8&autoReconnect=true&useSSL=false")
